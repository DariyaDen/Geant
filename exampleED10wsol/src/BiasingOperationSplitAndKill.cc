...
BiasingOperationSplitAndKill::BiasingOperationSplitAndKill(G4String name)
...
BiasingOperationSplitAndKill::~BiasingOperationSplitAndKill()
{}


//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

G4double BiasingOperationSplitAndKill::DistanceToApplyOperation( const G4Track*,
								   G4double,
...
G4VParticleChange*  BiasingOperationSplitAndKill::GenerateBiasingFinalState( const G4Track* track,
									       const G4Step*  step )
{
       ...
       ( track->GetCurrentStepNumber() != 1 ) )
  {
    ...
    else if ( postCopyNo < preCopyNo )
    {
      ...
      // Decide to kill with 50% probability:
      G4double killingProbability = 0.5;
      ...
      {
        // In this case, the track survives. We change its weight to conserve weight
        // among killed and survival tracks:
        fParticleChange.ProposeParentWeight( initialWeight/killingProbability );
      }
