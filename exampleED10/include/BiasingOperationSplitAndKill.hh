...
// $Id: $
//
/// \file BiasingOperationSplitAndKill.hh
/// \brief Definition of the BiasingOperationSplitAndKill class

#ifndef BiasingOperationSplitAndKill_hh
#define BiasingOperationSplitAndKill_hh 1
...
class BiasingOperationSplitAndKill : public G4VBiasingOperation
{
  public:
    // -- Constructor :
    BiasingOperationSplitAndKill(G4String name);
    // -- destructor:
    ~BiasingOperationSplitAndKill() override;
  ...
  public:
    ...
    const G4VBiasingInteractionLaw* ProvideOccurenceBiasingInteractionLaw(
        const G4BiasingProcessInterface*, G4ForceCondition&) override {return nullptr;}
  ...
  private:
    ...
    G4LogicalVolume            *fShieldSlice = nullptr;
};
